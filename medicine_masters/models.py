...
class Order(models.Model):
    ...
    order_amount = models.CharField(max_length=150, null=False)
    order_discount_price = models.CharField(max_length=150, null=True)
    order_total_amount = models.DecimalField(max_digits=10, decimal_places=2, null=False)
    shipping_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=10.00)
    order_status = models.CharField(max_length=100, default="Order Confirmed")
